    ...
    >
      ...
      <g>
        ...
        <path
          ...
          style={{ clipPath: "url(#SVGID_2_)", fill: "#fbbc05" }}
        ></path>
        <defs>
          <path
            id="SVGID_3_"
        ...
        <path
          ...
          style={{ clipPath: "url(#SVGID_4_)", fill: "#ea4335" }}
        ></path>
        <g>
          <defs>
            <path
          ...
          <path
            ...
            style={{ clipPath: "url(#SVGID_6_)", fill: "#34a853" }}
          ></path>
        </g>
        <g>
          <defs>
          ...
          <path
            ...
            style={{ clipPath: "url(#SVGID_8_)", fill: "#4285f4" }}
          ></path>
        </g>
      </g>
    </svg>
